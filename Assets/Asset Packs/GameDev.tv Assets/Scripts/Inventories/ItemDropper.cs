...
namespace GameDevTV.Inventories
{
    ...
    public class ItemDropper : MonoBehaviour, ISaveable
    {
        ...
        private List<DropRecord> droppedItemsOnAnotherScene = new List<DropRecord>();
        ...
        object ISaveable.CaptureState()
        {
            ...
            droppedItemsList.AddRange(droppedItemsOnAnotherScene);
        ...
        void ISaveable.RestoreState(object state)
        {
            ...
            int sceneIndex = GetSceneIndex();
            droppedItemsOnAnotherScene.Clear();

            foreach (var item in droppedItemsList)
            {
                if (item.sceneBuildIndex != sceneIndex)
                {
                    droppedItemsOnAnotherScene.Add(item);
                    continue;
                }
